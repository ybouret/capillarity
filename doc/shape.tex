...
The we assume that we have fit of $\rho(\alpha)$ for $\alpha\in[0,\beta]$.
We need a $\mathcal{C}^2$ continuation of $\rho$ for $\alpha\in[\beta,\pi]$.
The continuous fit gives us $\rho(\beta),\rho'(\beta)$ and $\rho''(\beta)$.
We need to expand it to $\rho_\pi,\rho'(\pi)=0$ and $\rho''(\pi)=0$.
